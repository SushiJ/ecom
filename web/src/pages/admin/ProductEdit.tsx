...
const ProductEdit = () => {
  ...
  const { data: product, isLoading, refetch, error } = useGetProductsByIdQuery(productId);
          ...
          {isLoading || delay ? (
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <fieldset
                  className={clsx(loadingUpdate ? "opacity-50" : "opacity-100", "space-y-2")}
                >
                  <FormField
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input {...field} className="hidden" value={productId} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
